function varargout = TrackUSF(varargin)
%TRACKUSF MATLAB code file for TrackUSFss.fig
%      TRACKUSF, by itself, creates a new TRACKUSF or raises the existing
%      singleton*.
%
%      H = TRACKUSF returns the handle to a new TRACKUSF or the handle to
%      the existing singleton*.
%
%      TRACKUSF('Property','Value',...) creates a new TRACKUSF using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to TrackUSF_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      TRACKUSF('CALLBACK') and TRACKUSF('CALLBACK',hObject,...) call the
%      local function named CALLBACK in TRACKUSF.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help TrackUSF

% Last Modified by GUIDE v2.5 24-May-2020 15:49:30

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @TrackUSF_OpeningFcn, ...
                   'gui_OutputFcn',  @TrackUSF_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before TrackUSF is made visible.
function TrackUSF_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for TrackUSF
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes TrackUSF wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = TrackUSF_OutputFcn(hObject, eventdata, handles)
...
HandlesForGUIControls.NumOfAudioFiles_tSNEGroup_A_EditBox.String=num2str(length(tSNEAudioGroup_A_FileList));
HandlesForGUIControls.MainStatusTextEditBox.String=[num2str(length(tSNEAudioGroup_A_FileList)) ' audio files were chosen'];
...
HandlesForGUIControls.NumOfAudioFiles_tSNEGroup_B_EditBox.String=num2str(length(tSNEAudioGroup_B_FileList));
HandlesForGUIControls.MainStatusTextEditBox.String=[num2str(length(tSNEAudioGroup_B_FileList)) ' audio files were chosen'];
...
HandlesForGUIControls.NumOfAudioFiles_tSNEGroup_C_EditBox.String=num2str(length(tSNEAudioGroup_C_FileList));
HandlesForGUIControls.MainStatusTextEditBox.String=[num2str(length(tSNEAudioGroup_C_FileList)) ' audio files were chosen'];
...
HandlesForGUIControls.NumOfAudioFiles_tSNEGroup_D_EditBox.String=num2str(length(tSNEAudioGroup_D_FileList));
HandlesForGUIControls.MainStatusTextEditBox.String=[num2str(length(tSNEAudioGroup_D_FileList)) ' audio files were chosen'];
...
HandlesForGUIControls.NumOfAudioFiles_tSNEGroup_E_EditBox.String=num2str(length(tSNEAudioGroup_E_FileList));
HandlesForGUIControls.MainStatusTextEditBox.String=[num2str(length(tSNEAudioGroup_E_FileList)) ' audio files were chosen'];
...
HandlesForGUIControls.NumOfAudioFiles_tSNEGroup_F_EditBox.String=num2str(length(tSNEAudioGroup_F_FileList));
HandlesForGUIControls.MainStatusTextEditBox.String=[num2str(length(tSNEAudioGroup_F_FileList)) ' audio files were chosen'];
...
HandlesForGUIControls.NumOfAudioFiles_tSNEGroup_G_EditBox.String=num2str(length(tSNEAudioGroup_G_FileList));
HandlesForGUIControls.MainStatusTextEditBox.String=[num2str(length(tSNEAudioGroup_G_FileList)) ' audio files were chosen'];
...
HandlesForGUIControls.NumOfAudioFiles_tSNEGroup_H_EditBox.String=num2str(length(tSNEAudioGroup_H_FileList));
HandlesForGUIControls.MainStatusTextEditBox.String=[num2str(length(tSNEAudioGroup_H_FileList)) ' audio files were chosen'];
...
HandlesForGUIControls.NumOfAudioFiles_tSNEGroup_I_EditBox.String=num2str(length(tSNEAudioGroup_I_FileList));
HandlesForGUIControls.MainStatusTextEditBox.String=[num2str(length(tSNEAudioGroup_I_FileList)) ' audio files were chosen'];
...
HandlesForGUIControls.NumOfAudioFiles_tSNEGroup_J_EditBox.String=num2str(length(tSNEAudioGroup_J_FileList));
HandlesForGUIControls.MainStatusTextEditBox.String=[num2str(length(tSNEAudioGroup_J_FileList)) ' audio files were chosen'];
...
HandlesForGUIControls.NumOfAudioFiles_tSNEGroup_K_EditBox.String=num2str(length(tSNEAudioGroup_K_FileList));
HandlesForGUIControls.MainStatusTextEditBox.String=[num2str(length(tSNEAudioGroup_K_FileList)) ' audio files were chosen'];
...
HandlesForGUIControls.NumOfAudioFiles_tSNEGroup_L_EditBox.String=num2str(length(tSNEAudioGroup_L_FileList));
HandlesForGUIControls.MainStatusTextEditBox.String=[num2str(length(tSNEAudioGroup_L_FileList)) ' audio files were chosen'];
...
HandlesForGUIControls.MainStatusTextEditBox.String='Start the analysis...';
...
tSNEAudioGroup_K_FileList,tSNEAudioGroup_K_FilePath,tSNEAudioGroup_L_FileList,tSNEAudioGroup_L_FilePath,HandlesForGUIControls);
HandlesForGUIControls.MainStatusTextEditBox.String='Analysis done';
...
if isempty(LastPathChoosen) | LastPathChoosen==0
   ...
   if ischar(tSNEResultFileList)
      ...
      try
         ...
         HandlesForGUIControls.MainStatusTextEditBox.String='3D-tSNE result data was uploaded';
      catch
         HandlesForGUIControls.MainStatusTextEditBox.String='3D-tSNE result data was not uploaded';
...
[tSNE_AnalysisData3D_Scatter3_Obj,TimeFramesFor_tSNE_Analysis_for_Scatter3_obj]=...
PopulationAudioAlone_tSNE_results_OpenGraph(PopAudioAlone_tSNE_AnalysisData3D,...
FinalAudioGroupNameListFor_tSNE_Analysis,TimeFramesFor_tSNE_Analysis,labelFor_tSNE_Analysis,HandlesForGUIControls);
HandlesForGUIControls.MainStatusTextEditBox.String='tSNE data was opened';
...
HandlesForGUIControls.MainStatusTextEditBox.String='Please define audio clusters';
[tSNE_AnalysisData3D_Scatter3_Obj,AllClustersTimeFramesPerGroup,AllClusters_tSNE_XYZCord,...
...
[tSNE_AnalysisData3D_figure,tSNE_AnalysisData3D_Scatter3_Obj,AllClustersTimeFramesPerGroup,AllClusters_tSNE_XYZCord,...
AllClustersTimeFramesPerOriginalFile,Cluster_tSNE_AnalysisData3D_Scatter3_Obj,AllClustersTextObj]=...
...
AllClustersTimeFramesPerOriginalFile,Cluster_tSNE_AnalysisData3D_Scatter3_Obj,tSNE_AnalysisData3D_figure,AllClustersTextObj,HandlesForGUIControls);
HandlesForGUIControls.MainStatusTextEditBox.String='Audio cluster was deleted';
...
% --- Executes on button press in AutomaticClusteringResultsPushbutton.
function AutomaticClusteringResultsPushbutton_Callback(hObject, eventdata, handles)
% hObject    handle to AutomaticClusteringResultsPushbutton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
HandlesForGUIControls.MainStatusTextEditBox.String='Please wait,automatic clustering is in process....';
[tSNE_AnalysisData3D_Scatter3_Obj,AllClustersTimeFramesPerGroup,AllClusters_tSNE_XYZCord,...
AllClustersTimeFramesPerOriginalFile,Cluster_tSNE_AnalysisData3D_Scatter3_Obj,AllClustersTextObj]=...
...
tSNE_AnalysisData3D_Scatter3_Obj,TimeFramesFor_tSNE_Analysis_for_Scatter3_obj,AllClustersTimeFramesPerGroup,...
AllClusters_tSNE_XYZCord,AllClustersTimeFramesPerOriginalFile,Cluster_tSNE_AnalysisData3D_Scatter3_Obj,AllClustersTextObj,handles);
HandlesForGUIControls.MainStatusTextEditBox.String='Automatic clustering is done';
...
AllClustersTextObj,HandlesForGUIControls);
HandlesForGUIControls.MainStatusTextEditBox.String='Clusters data was saved';
...
HandlesForGUIControls.NumOfAudioFilesChosenEditBox.String=num2str(length(AudiofileList));
HandlesForGUIControls.MainStatusTextEditBox.String='Audio .mat files were uploaded';
...
HandlesForGUIControls.NumOfAudioClustersFilesChosenEditBox.String=num2str(length(AudioClustersfileList));
HandlesForGUIControls.MainStatusTextEditBox.String='Audio clusters files were uploaded';
...
try
   ...
   HandlesForGUIControls.MainStatusTextEditBox.String='Loading data...';
   pause(1);
   ...
   CurrentSessionAudioClustersFileToPresent=[AudioClustersFilesPath,AudioClustersfileList{1,CurrentSessionAudioClustersFileNumToPresent-1}];
   HandlesForGUIControls.MainStatusTextEditBox.String='No more file to forward, please go back';
   return;
end
...
SessionAudioSpectrogramFigure=SessionAudioAlone_Analysis_27032018(CurrentSessionAudioClustersFileToPresent,CurrentSessionAudioFileToPresent,...
   ...
   CurrentSessionAudioAloneSecToPresent,SessionAudioSpectrogramFigure,Fs,HandlesForGUIControls); 
...
try
   ...
   CurrentSessionAudioClustersFileToPresent=[AudioClustersFilesPath,AudioClustersfileList{1,CurrentSessionAudioClustersFileNumToPresent+1}];
   HandlesForGUIControls.MainStatusTextEditBox.String='No more file to go back, please go forward';
   return;
end
...
try
   ...
   HandlesForGUIControls.MainStatusTextEditBox.String='No more sec, please go forward';
   return;
end
...
try
   ...
   HandlesForGUIControls.MainStatusTextEditBox.String='No more sec, please go back';
   return;
end
...
HandlesForGUIControls.MainStatusTextEditBox.String='Loading...';
...
if find(diff(NumOfFiles)>0)
   ...
   HandlesForGUIControls.MainStatusTextEditBox.String='The number of files of audio clusters and Audio data files is not equal';
end 
try
   ...
   CurrentSessionAudioAloneSecToPresent=1;
   CurrentSessionAudioClustersFileNumToPresent=1;
   HandlesForGUIControls.MainStatusTextEditBox.String='Audio cluster data was uploaded';
catch
   HandlesForGUIControls.MainStatusTextEditBox.String='Audio .mat files or cluster data files were not uploaded';
...
try
   ...
   CurrentSessionAudioFileDataToPresent=TempAudioData;
   CurrentSessionAudioFileNumToPresent=1;
   HandlesForGUIControls.MainStatusTextEditBox.String='Audio data was uploaded';
catch
   HandlesForGUIControls.MainStatusTextEditBox.String='Audio data was not uploaded'; 
...
function PopPost_tSNE_NoiseClusterEditBox_Callback(hObject, eventdata, handles)
% hObject    handle to PopPost_tSNE_NoiseClusterEditBox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of PopPost_tSNE_NoiseClusterEditBox as text
%        str2double(get(hObject,'String')) returns contents of PopPost_tSNE_NoiseClusterEditBox as a double


% --- Executes during object creation, after setting all properties.
function PopPost_tSNE_NoiseClusterEditBox_CreateFcn(hObject, eventdata, handles)
% hObject    handle to PopPost_tSNE_NoiseClusterEditBox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in PopAudio_tSNE_AverPSDSameClusterCheckbox.
function PopAudio_tSNE_AverPSDSameClusterCheckbox_Callback(hObject, eventdata, handles)
% hObject    handle to PopAudio_tSNE_AverPSDSameClusterCheckbox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of PopAudio_tSNE_AverPSDSameClusterCheckbox


% --- Executes on button press in Audio_tSNE_NumOfCallsPerClusterCheckbox.
function Audio_tSNE_NumOfCallsPerClusterCheckbox_Callback(hObject, eventdata, handles)
% hObject    handle to Audio_tSNE_NumOfCallsPerClusterCheckbox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of Audio_tSNE_NumOfCallsPerClusterCheckbox


% --- Executes on button press in PopAudioClustersNumAlongTimeCheckBox.
function PopAudioClustersNumAlongTimeCheckBox_Callback(hObject, eventdata, handles)
% hObject    handle to PopAudioClustersNumAlongTimeCheckBox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of PopAudioClustersNumAlongTimeCheckBox


% --- Executes on button press in Audio_tSNE_ClustersProbabilityToOthersCheckbox.
function Audio_tSNE_ClustersProbabilityToOthersCheckbox_Callback(hObject, eventdata, handles)
% hObject    handle to Audio_tSNE_ClustersProbabilityToOthersCheckbox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of Audio_tSNE_ClustersProbabilityToOthersCheckbox


% --- Executes on button press in PSD_AlUSFsExcludingNoiseCheckbox.
function PSD_AlUSFsExcludingNoiseCheckbox_Callback(hObject, eventdata, handles)
% hObject    handle to PSD_AlUSFsExcludingNoiseCheckbox (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of PSD_AlUSFsExcludingNoiseCheckbox


% --- Executes on button press in StartAudioPopPostAnalysisPushbutton.
function StartAudioPopPostAnalysisPushbutton_Callback(hObject, eventdata, handles)
% hObject    handle to StartAudioPopPostAnalysisPushbutton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
HandlesForGUIControls.MainStatusTextEditBox.String='Analyzing...';
PopulationAudioAlonePost_tSNEAnalysis_10112019(AudioClustersFilesPath,AudioClustersfileList,AudioFilesPath,AudiofileList,HandlesForGUIControls);
HandlesForGUIControls.MainStatusTextEditBox.String='Analysis is finish';
